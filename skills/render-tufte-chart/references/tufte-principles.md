...
For each: Tufte's own name, the VDQI page, the construction recipe (quoted where possible), and when to use it. A render script ships for several; the rest you build directly in SVG following the recipe.
